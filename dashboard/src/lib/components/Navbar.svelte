...
<nav class="z-10 fixed w-screen flex items-center justify-between bg-surface-600 dark:bg-surface-900 text-surface-50">
    <div class="flex items-center">
        <a href="/" class="flex items-center gap-4 px-4 py-2 hover:bg-surface-800 dark:hover:bg-surface-600 transition-colors duration-200">
        ...
        {#each links as [href, icon, label, brand, external]}
            ...
            <a
                ...
                class="flex items-center text-lg p-4 hidden xl:block hover:bg-surface-800 dark:hover:bg-surface-600 transition-colors duration-200"
            >
    ...
    <div class="flex items-center">
        {#if $page.data.user}
            <div class="hidden xl:block hover:bg-surface-800 dark:hover:bg-surface-600 transition-colors duration-200">
                <a href="/account">
                    <LoggedInAs />
                </a>
            </div>
            ...
            <a
                ...
                class="flex items-center gap-2 text-lg p-4 hidden xl:block hover:bg-surface-800 dark:hover:bg-surface-600 transition-colors duration-200"
            >
        ...
        {/if}
        <button
            class="w-16 py-6 flex flex-col items-center hover:bg-surface-800 dark:hover:bg-surface-600 transition-colors duration-200"
        ...
        <button
            class="w-16 py-6 flex flex-col items-center block xl:hidden hover:bg-surface-800 dark:hover:bg-surface-600 transition-colors duration-200"
        ...
        <div class="h-full flex flex-col justify-between">
            <div class="flex flex-col">
                <div class="flex flex-col items-end">
                    <button
                        class="right-0 w-16 py-6 flex flex-col items-center hover:bg-surface-800 dark:hover:bg-surface-600 transition-colors duration-200"
                ...
                {#each links as [href, icon, label, brand, external], index}
                    ...
                    <a
                        {href}
                        target={external ? "_blank" : null}
                        class="flex items-center text-lg p-4 hover:bg-surface-800 dark:hover:bg-surface-600 transition-colors duration-200"
                    >
            ...
            <div class="flex flex-col">
                {#if $page.data.user}
                    <div class="px-4 hover:bg-surface-800 dark:hover:bg-surface-600 transition-colors duration-200">
                        <a href="/account">
                            <LoggedInAs />
                        </a>
                    </div>
